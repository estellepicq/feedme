...
"use strict";"classList"in document.documentElement||!Object.defineProperty||"undefined"==typeof HTMLElement||Object.defineProperty(HTMLElement.prototype,"classList",{get:function(){var e=this;function t(t){return function(s){var n=e.className.split(/\s+/),i=n.indexOf(s);t(n,i,s),e.className=n.join(" ")}}var s={add:t(function(e,t,s){~t||e.push(s)}),remove:t(function(e,t){~t&&e.splice(t,1)}),toggle:t(function(e,t,s){~t?e.splice(t,1):e.push(s)}),contains:function(t){return!!~e.className.split(/\s+/).indexOf(t)},item:function(t){return e.className.split(/\s+/)[t]||null}};return Object.defineProperty(s,"length",{get:function(){return e.className.split(/\s+/).length}}),s}});var searchSection=document.getElementById("search"),listElt=document.getElementById("list"),filteredListElt=document.getElementById("filteredList"),searchInput=document.getElementById("searchInput"),noFoodMessage=document.getElementById("noFoodMessage"),filteredItemElts=document.getElementsByClassName("filtered-item");searchInput&&searchInput.addEventListener("keyup",function(){var e=searchInput.value.toUpperCase();if(searchInput.value){searchSection.classList.add("filtering"),searchSection.classList.add("filtering");for(var t=0;t<filteredItemElts.length;t++){(filteredItemElts[t].textContent||filteredItemElts[t].innerText).toUpperCase().indexOf(e)>-1?filteredItemElts[t].classList.add("displayed"):filteredItemElts[t].classList.remove("displayed")}}else searchSection.classList.remove("filtering")});
